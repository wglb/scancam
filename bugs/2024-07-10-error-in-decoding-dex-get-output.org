...
Backtrace for: #<SB-THREAD:THREAD "main thread" RUNNING {1004C30093}>
...
6: (SB-EXT:CALL-WITH-TIMING #<FUNCTION SB-IMPL::PRINT-TIME> #<FUNCTION (LAMBDA NIL :IN DISPATCH-RESCANCAM) {1BC513487BDB}>)
