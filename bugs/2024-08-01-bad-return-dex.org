...
Backtrace for: #<SB-THREAD:THREAD "main thread" RUNNING {1005F10093}>
...
6: (SB-EXT:CALL-WITH-TIMING #<FUNCTION SB-IMPL::PRINT-TIME> #<FUNCTION (LAMBDA NIL :IN DISPATCH-RESCANCAM) {3447AE687BDB}>)
